...
Nbgrader прячет от студентов решения и тесты, если использовать соответствующие бракеты. Все бракеты и их содержимое будут скрыты от студента и заменены на фразы типа  \grqqВведите решение\grqq.
...
Для того, чтобы их \grqqзабрать\grqq, надо нажать на облачко в графе collect.
